...
const currentHref = computed(() => (page.props.ziggy?.location ? new URL(page.props.ziggy.location).href : ''));

const isCurrentRoute = computed(() => (href: string) => currentHref.value === href);
