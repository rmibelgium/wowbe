...
class Oracle
{
     ...
     *
     * @see https://intrarmi.oma.be/oracle/oda/columns/column/CLIMAT/AWS_STATION/2
     * @see https://intrarmi.oma.be/oracle/oda/columns/column/METADATA/STATION/2
     * @see https://intrarmi.oma.be/oracle/oda/columns/column/METADATA/LOCATION/3
     */
    public function getStations(bool $debug = false, ?OutputInterface $output = null): array
    {
        ...
        SQL, [], $debug ? $output : null);
    }

    /**
     * @return array<string,mixed>
     *
     *  @see https://intrarmi.oma.be/oracle/oda/columns/column/CLIMAT/AWS_10MIN/3
     */
    public function getAWS10Min(DateTime $from, DateTime $to, bool $debug = false, ?OutputInterface $output = null): array
    {
        return $this->query(<<<'SQL'
            ...
            ORDER BY S.STAT_ID ASC
        SQL, [
            ':from_param' => $from->format('Y-m-d H:i:s'),
            ':to_param' => $to->format('Y-m-d H:i:s'),
        ], $debug ? $output : null);
    }
